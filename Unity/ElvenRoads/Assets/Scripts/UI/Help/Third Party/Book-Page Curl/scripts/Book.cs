...
public class Book : MonoBehaviour {
    ...
    private void Awake()
    {
        TryGetComponent(out m_autoFlip);
    }
    ...
    {
        if (interactable)
        DragRightPageToPoint(transformPoint(Mouse.current.position.ReadValue()));
    ...
    {
        if (interactable)
        DragLeftPageToPoint(transformPoint(Mouse.current.position.ReadValue()));
    ...
    public void JumpToPage(int page_number)
    {
